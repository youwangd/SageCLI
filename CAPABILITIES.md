...
- Custom tool scripts (tool add/ls/rm/show — register, list, remove, and inspect custom tool scripts)
...
- Per-command help (sage help <command> — focused usage, flags, and examples for send, create, plan, logs, history)
